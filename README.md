...
- `Supporting_Data`: Directory containing supporting geospatial data for the treasure map, including:
  ...
  - The continental inventory of inferred subglacial lakes in Antarctica from [Livingstone et al. (2022)](https://doi.org/10.1038/s43017-021-00246-9) (`Livingstoneetal2022-SubglacialLakes_AntarcticLakes.shp`), supplemented by the 85 new active subglacial lakes recently identified by [Wilson et al. (2025)](https://doi.org/10.1038/s41467-025-63773-9) (`Wilsonetal2025-Detection85_NewActiveLakes`).
